...
export default function FooterMain() {
  return (
    <footer className="w-full max-w-7xl mx-auto px-6 py-8 md:py-12 border-t border-white/10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-1">
          ...
          <h3 className="font-medium text-lg mt-6 mb-4">Get in Touch</h3>
          <ul className="space-y-2">
            <li>
              <a href="mailto:support@envobyte.com" className="footer-link">
                support@envobyte.com
              </a>
            </li>
            <li>
              <a href="tel:+18677772477" className="footer-link">
                +1 (867) 777 2477
              </a>
            </li>
          </ul>
